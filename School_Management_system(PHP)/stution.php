<html>
<body>
<h1 style="color:#ff6ec7;">&emsp;TUTION FEES</h1>
...
if(isset($_POST))
{
    ...
    $conn=new mysqli($servername,$username,$password,$database);
		...
		$sql = "UPDATE t2 SET stution = 0 ";
		$result=$conn->query($sql);


		if ($result)
		{
			echo "<span style='color:#000000;font-size:20px;font-family:arial'>All Tution Fees updated to 0";
		}
		else 
		{
